...
``` Нужно представиться гиту, создать две команды в терминале, где необходимо написать свое имя, лучше написать свое, по которому другие участники команды будут понимать, что ты - это ты и, написать свою почту. ```

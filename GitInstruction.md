...
* Создать новую ветку из ветки MAIN

* Перейти в новую ветку

* Внести изменение  впрект (создать новые файлы, папки, изменить существующие)

* Создать коммит или несколько коммитов в новой ветке

* Вернуться в ветку MAIN и также создать коммиты

* Выполнить слияние новой ветки в ветку MAIN

* После слияния, новую ветку можно удалить

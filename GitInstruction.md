...
## Создание и базовая работа с локальным репозиторием.
 создаем папку и открываем ее и делаем репозиторией его командой git init и создаем файл на котором будем работать и добавим его с командой git add (имя файла)

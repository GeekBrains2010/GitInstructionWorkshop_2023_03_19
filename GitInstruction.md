...
Fork необходим для копирования удаленного репозитория другого пользователя в свой удаленный репозиторий.

Pull request необходим для предложения своих изменений в форкнутой версии другого пользователя.
